	...
	<el-row :gutter="24">
		<el-col :span="24">
			<el-form-item label="商品类型：" props="is_virtual">
				<div class="virtual" :class="formValidate.virtual_type == item.id ? 'virtual_boder' : 'virtual_boder2'"
					v-for="(item, index) in goodsType" :key="index" v-db-click @click="virtualbtn(item.id, 2)" v-show="
		...
		<el-col :span="24">
			<el-form-item label="商品名称：" prop="store_name">
				<el-input class="content_width" v-model="formValidate.store_name" placeholder="请输入商品名称" maxlength="80"
					show-word-limit />
			</el-form-item>
		</el-col>
		...
		<el-col :span="24">
			<el-form-item label="商品分类：" prop="cate_id">
				<el-cascader class="content_width" v-model="formValidate.cate_id" filterable size="small"
					:options="treeSelect" :props="{ multiple: true, checkStrictly: true, emitPath: false }"
		...
		<el-col :span="24">
			<el-form-item label="商品标签：">
				<div class="flex">
					<useLabel v-if="tileLabelList.length" :activeId.sync="formValidate.label_list"
						:listData="tileLabelList"></useLabel>
