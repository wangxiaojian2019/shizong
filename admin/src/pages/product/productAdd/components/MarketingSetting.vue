	...
	<el-row>
		...
		<el-col :span="24" v-if="formValidate.virtual_type == 0">
			<el-form-item label="开启送礼：">
				<el-switch v-model="formValidate.is_gift" class="defineSwitch" active-text="开启" inactive-text="关闭"
					:active-value="1" :inactive-value="0" size="large">
				</el-switch>
		...
		<el-col :span="24" v-if="formValidate.virtual_type == 0 && formValidate.is_gift">
			<el-form-item label="礼品附加费：">
				<el-input-number :controls="false" :min="0" :max="100000" v-model="formValidate.gift_price"
					placeholder="请输入礼品附加费" class="input_width input-number-unit-class" class-unit="元" />
