...
export function getnumberPlate(params) {
	return request({
		url: `product/numberPlate`,
		method: 'get',
		params,
	});
}

export function getagentPrice(params) {
	return request({
...
export function categoryupdate(id, data, state) {
	return request({
		url: `product/category/${id}/${state}`,
		method: 'put',
		data,
	});
}
...
/** 拍卖专场 — 回显围观人数 */
export function getCateViewApi(id) {
	return request({
		url: `product/category/get_view/${id}`,
		method: 'get',
	});
}

/** 拍卖专场 — 配置围观人数 */
export function setCateViewApi(id, data) {
	return request({
		url: `product/category/set_view/${id}`,
		method: 'put',
		data,
	});
}