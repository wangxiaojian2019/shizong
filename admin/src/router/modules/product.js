...
export default {
  ...
  children: [
    ...
    },
    {
      ...
      name: `${pre}auctionSession`,
      meta: {
        auth: ['product-auction-session'],
        title: '限时拍拍卖周期',
      },
      component: () => import('@/pages/product/auction_session/index'),
    },
    {
      path: 'timed_deposit_config',
      name: `${pre}timedDepositConfig`,
      meta: {
        auth: ['product-timed-deposit-config'],
        title: '限时拍保证金设置',
      },
      component: () => import('@/pages/product/timed_deposit_config/index'),
    },
  ],
};
