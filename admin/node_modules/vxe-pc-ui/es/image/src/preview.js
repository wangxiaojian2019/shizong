...
export default {
    ...
    computed: Object.assign(Object.assign({}, {}), { computeUrlProp() {
            const $xeImagePreview = this;
        ...
        computeImgList() {
            ...
            const props = $xeImagePreview;
            const { urlList } = props;
            const urlProp = $xeImagePreview.computeUrlProp;
    ...
    methods: {
        ...
        resetStyle() {
            const $xeImagePreview = this;
            const reactData = $xeImagePreview.reactData;
            const elem = $xeImagePreview.$refs.refElem;
        ...
        renderOperationBtn(h, code, icon) {
            const $xeImagePreview = this;
            const toolbarOpts = $xeImagePreview.computeToolbarOpts;
