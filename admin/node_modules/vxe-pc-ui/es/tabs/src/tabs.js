...
export default {
    ...
    computed: Object.assign(Object.assign({}, {}), { computeParentTabsResizeFlag() {
            const $xeTabs = this;
    ...
    methods: {
        ...
        checkScrolling() {
            ...
            const headPrevEl = $xeTabs.$refs.refHeadPrevElem;
            const headNextEl = $xeTabs.$refs.refHeadNextElem;
            if (headerWrapperEl) {
