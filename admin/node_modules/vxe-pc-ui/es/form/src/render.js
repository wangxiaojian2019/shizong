...
export function renderTitle(h, $xeForm, item, isGroup) {
    const formProps = $xeForm;
    const $xeGrid = $xeForm.$xeGrid;
    ...
    if (titlePrefix) {
        titVNs.push((titlePrefix.content || titlePrefix.message)
            ? h(VxeTooltipComponent, {
                props: Object.assign(Object.assign(Object.assign({}, tooltipOpts), titlePrefix), { content: getFuncText(titlePrefix.content || titlePrefix.message) }),
                scopedSlots: {
    ...
    if (titleSuffix) {
        fixVNs.push((titleSuffix.content || titleSuffix.message)
            ? h(VxeTooltipComponent, {
                props: Object.assign(Object.assign(Object.assign({}, tooltipOpts), titleSuffix), { content: getFuncText(titleSuffix.content || titleSuffix.message) }),
                scopedSlots: {
...
export const renderItemContent = (h, $xeForm, item) => {
    const formProps = $xeForm;
    const formReactData = $xeForm.reactData;
