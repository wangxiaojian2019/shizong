...
export default {
    ...
    methods: {
        ...
        getBox() {
            const $xeDrawer = this;
            const boxElem = $xeDrawer.$refs.refDrawerBox;
            return boxElem;
        },
        recalculate() {
            const $xeDrawer = this;
        ...
        openDrawer() {
            ...
            if (!initialized) {
                ...
                if (btnTransfer) {
                    const panelElem = $xeDrawer.$refs.refElem;
            ...
            if (!visible) {
                ...
                setTimeout(() => {
                    ...
                    $xeDrawer.$nextTick(() => {
                        if (showFooter) {
                            const confirmBtn = $xeDrawer.$refs.refConfirmBtn;
                            const cancelBtn = $xeDrawer.$refs.refCancelBtn;
