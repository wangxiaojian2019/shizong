        ...
        handleGlobalContextmenuEvent(evnt) {
            ...
            if (isEnableConf(menuConfig) || contextMenu) {
                ...
                if (internalData._keyCtx) {
                    const type = 'body';
                    const params = { type, $grid: $xeGrid, $table: this, keyboard: true, columns: this.visibleColumn.slice(0), $event: evnt };
                    // 如果开启单元格区域
                ...
                for (let index = 0; index < layoutList.length; index++) {
                    ...
                    const params = { type: layout, $grid: $xeGrid, $table: this, columns: this.visibleColumn.slice(0), $event: evnt };
