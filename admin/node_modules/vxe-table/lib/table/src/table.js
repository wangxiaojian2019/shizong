...
function renderEmptyBody(h, $xeTable) {
  ...
  if (emptySlot) {
    ...
    if (rtEmptyView) {
      emptyContent = (0, _vn.getSlotVNs)(rtEmptyView.call($xeTable, h, emptyOpts, emptyParams));
    } else {
      emptyContent = (0, _utils.getFuncText)($xeTable.emptyText) || getI18n('vxe.table.emptyText');
    }
  }
  return emptyContent;
}
  ...
  created() {
    ...
    if (!$xeTable.handlePivotTableAggregateData) {
      if (customOpts.allowGroup) {
        (0, _log.errLog)('vxe.error.notProp', ['custom-config.allowGroup']);
        return;
      }
      if (customOpts.allowValues) {
        (0, _log.errLog)('vxe.error.notProp', ['custom-config.allowValues']);
        return;
      }
    }
    ...
    if (aggregateOpts.aggregateMethod) {
      (0, _log.warnLog)('vxe.error.delProp', ['row-group-config.aggregateMethod', 'aggregate-config.countMethod']);
    }
    ...
    $xeTable.$nextTick(() => {
      if (props.loading) {
        if (!VxeUILoadingComponent && !this.$scopedSlots.loading) {
          (0, _log.errLog)('vxe.error.errProp', ['loading=true', 'loading=false | <template #loading>...</template>']);
      ...
      if (props.showOverflow === true || props.showOverflow === 'tooltip' || props.showHeaderOverflow === true || props.showHeaderOverflow === 'tooltip' || props.showFooterOverflow === true || props.showFooterOverflow === 'tooltip' || props.tooltipConfig || props.editRules) {
        if (!VxeUITooltipComponent) {
          if (props.showOverflow === true) {
            (0, _log.errLog)('vxe.error.errProp', ['show-overflow=true', 'show-overflow=title']);
          }
          if (props.showOverflow === 'tooltip') {
            (0, _log.errLog)('vxe.error.errProp', ['show-overflow=tooltip', 'show-overflow=title']);
          }
          if (props.showHeaderOverflow === true) {
            (0, _log.errLog)('vxe.error.errProp', ['show-header-overflow=true', 'show-header-overflow=title']);
          }
          if (props.showHeaderOverflow === 'tooltip') {
            (0, _log.errLog)('vxe.error.errProp', ['show-header-overflow=tooltip', 'show-header-overflow=title']);
          }
          if (props.showFooterOverflow === true) {
            (0, _log.errLog)('vxe.error.errProp', ['show-footer-overflow=true', 'show-footer-overflow=title']);
          }
          if (props.showFooterOverflow === 'tooltip') {
            (0, _log.errLog)('vxe.error.errProp', ['show-footer-overflow=tooltip', 'show-footer-overflow=title']);
          }
