...
class WechatUserDao extends BaseDao
{
    ...
    public function getuniOnid(int $uid){
        return $this->getModel()->where('uid', $uid)->value('unionid');
    }
    
    public function getOpenid(string $unionid = '',string $userType = 'wechat'){
        return $this->getModel()->where('unionid', $unionid)->where('user_type', $userType)->value('openid');
    }
    
    public function getlists(){
        return $this->getModel()->where('user_type', 'wechat')->select()->toArray();
    }
}
