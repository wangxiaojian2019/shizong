...
Route::group('product', function () {
    ...
    Route::group(function () {
        ...
        //专场围观人数回显
        Route::get('category/get_view/:id', 'v1.product.StoreCategory/get_view')->option(['real_name' => '专场围观人数回显']);
        //商品分类修改状态
        ...
        //专场围观人数配置
        Route::put('category/set_view/:id', 'v1.product.StoreCategory/set_view')->option(['real_name' => '专场围观人数配置']);
        //商品分类编辑表单
        Route::get('category/:id', 'v1.product.StoreCategory/edit')->option(['real_name' => '商品分类编辑表单']);
        //商品分类编辑
        Route::put('category/:id/:state', 'v1.product.StoreCategory/update')->option(['real_name' => '商品分类编辑']);
        //删除商品分类
...
//        Route::put('product/set_product/:id', 'v1.product.StoreProduct/set_product')->option(['real_name' => '商品快速编辑']);
        ...
        Route::get('numberPlate', 'v1.product.StoreNumberPlateController/getlist')->option(['real_name' => '获取号牌']);
        Route::post('editPlate', 'v1.product.StoreNumberPlateController/editPlate')->option(['real_name' => '编辑号牌']);
        Route::get('agentPrice', 'v1.product.StoreAgentPriceController/getlist')->option(['real_name' => '代理出价']);
        Route::post('refundOrder', 'v1.product.RefundController/refundOrder')->option(['real_name' => '保证金退款']);
        Route::get('timed_deposit/config', 'v1.product.StoreTimedDepositController/getConfig')->option(['real_name' => '限时拍保证金金额配置']);
        Route::post('timed_deposit/config', 'v1.product.StoreTimedDepositController/saveConfig')->option(['real_name' => '保存限时拍保证金金额']);
        Route::get('timed_deposit/pending', 'v1.product.StoreTimedDepositController/pendingList')->option(['real_name' => '限时拍保证金退款待审']);
        Route::post('timed_deposit/approve', 'v1.product.StoreTimedDepositController/approveRefund')->option(['real_name' => '限时拍保证金退款审核']);
        Route::post('timed_deposit/deduct', 'v1.product.StoreTimedDepositController/deduct')->option(['real_name' => '限时拍保证金违约扣减']);
        Route::get('auction_session/timed_categories', 'v1.product.StoreAuctionSessionController/timedCategories')->option(['real_name' => '可选限时拍专场列表']);
        Route::get('auction_session', 'v1.product.StoreAuctionSessionController/index')->option(['real_name' => '拍卖周期列表']);
        Route::post('auction_session', 'v1.product.StoreAuctionSessionController/create')->option(['real_name' => '创建拍卖周期']);
        Route::put('auction_session/:id', 'v1.product.StoreAuctionSessionController/update')->option(['real_name' => '修改拍卖周期']);
        Route::delete('auction_session/:id', 'v1.product.StoreAuctionSessionController/delete')->option(['real_name' => '删除拍卖周期']);
        Route::post('auction_session/bind', 'v1.product.StoreAuctionSessionController/bind')->option(['real_name' => '绑定限时拍专场到周期']);
