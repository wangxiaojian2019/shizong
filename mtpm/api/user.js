...
export function userRealname(real_name, card_id) {
	return request.get('user/realname', {
		real_name: real_name,
		card_id: card_id,
...
export function SendSubscribeMessage(product_id,openid) {
	return request.get('sendsubscribemessage', {
...
export function getScribeMessage(product_id) {
	return request.get('getScribeMessage', {
		product_id: product_id,
	}, {
		noAuth: true
	});
